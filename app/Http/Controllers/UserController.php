...
class UserController extends Controller
{
    ...
    public function delete_user_roles($admin_id)
    {
        if(Auth::id() == $admin_id)
        {
            return redirect()->back()->with('message','Không thể xóa tài khoản đang đăng nhập');
        }
        else
        {
    ...
    public function assign_roles(Request $request){
      ...
      {
          return redirect()->back()->with('message','Không thể phân quyền cho tài khoản đang đăng nhập  ');
      }
