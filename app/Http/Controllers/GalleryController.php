...
class GalleryController extends Controller
{
    ...
    {
    	$gal_id = $request->gal_id; // bằng với gal_id bên ajax layout gửi qua
    ...
    {	$gal_id = $request->gal_id;
     ...
     public function insert_gallery(Request $request,$pro_id){
     	...
     	if($get_image){
            ...
            $gallery->save();
            Session::put('message','Thêm gallery_image thành công');
    ...
    public function select_gallery(Request $request){
    	...
    	if($gallery_count>0){
    		...
    		foreach ($gallery as $key => $gal) {
    			...
    			$output.='  			  <tr>
    										<td>'.$i.'</td>
                                            <td contenteditable class="edit_gla_name" data-gal_id="'.$gal->gallery_id.'">'.$gal->gallery_name.'</td>
                                            <td>
    		...
    		$output.='  			  <tr>
    										<td colspan="4">Sản phẩm chưa có ảnh gallery</td>
